"""
Open the fifth student candidate object batch in Swift.

Run this file directly from the IDE, for example with Ctrl+F5.
The pytest file `test_student_candidate_parts_batch5.py` stays headless and fast.
"""
...
def add_part_buttons(env):
    if HEADLESS:
        return
    env.add(swift.Label("Student candidate parts, batch 5"))
...
def main():
    ...
    print("Animating student candidate parts batch 5 in Swift...")
