"""
Open the fifth student candidate robot batch in Swift.

Run this file directly from the IDE, for example with Ctrl+F5.
The pytest file `test_student_candidate_robots_batch5.py` stays headless and fast.
"""
...
from ir_support_extra_robots.robots.Pulse75.Pulse75 import Pulse75  # noqa: E402
from ir_support_extra_robots.robots.MotomanGP7.MotomanGP7 import MotomanGP7  # noqa: E402
from ir_support_extra_robots.robots.FanucCRX10IAL.FanucCRX10IAL import FanucCRX10IAL  # noqa: E402
from ir_support_extra_robots.robots.ABBIRB6740_260_300.ABBIRB6740_260_300 import ABBIRB6740_260_300  # noqa: E402
from ir_support_extra_robots.robots.OmronTM5900.OmronTM5900 import OmronTM5900  # noqa: E402
from ir_support_extra_robots.robots.KukaKR6R700CR.KukaKR6R700CR import KukaKR6R700CR  # noqa: E402
from ir_support_extra_robots.robots.KukaKR10.KukaKR10 import KukaKR10  # noqa: E402
...
def robot_camera_pose(robot, index):
    ...
    distance = min(max(span * 1.7, DEFAULT_CAMERA_DISTANCE), 5.5)
    look_at = base_position + np.array([0.0, 0.0, min(max(span * 0.35, 0.25), 1.6)])
    position = base_position + np.array([distance, -distance, min(max(distance * 0.55, 0.8), 3.2)])
...
def add_robot_buttons(env, robots):
    if HEADLESS:
        return
    env.add(swift.Label("Student candidate robots, batch 5"))
...
def main():
    ...
    print("Animating student candidate robot batch 5 in Swift...")
