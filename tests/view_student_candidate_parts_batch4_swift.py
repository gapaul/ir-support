"""
Open the fourth student candidate object batch in Swift.

Run this file directly from the IDE, for example with Ctrl+F5.
The pytest file `test_student_candidate_parts_batch4.py` stays headless and fast.
"""
...
def add_part_buttons(env):
    if HEADLESS:
        return
    env.add(swift.Label("Student candidate parts, batch 4"))
...
def main():
    ...
    print("Animating student candidate parts batch 4 in Swift...")
