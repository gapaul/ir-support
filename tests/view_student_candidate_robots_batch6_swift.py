"""
Open the sixth student candidate robot batch in Swift.

Run this file directly from the IDE, for example with Ctrl+F5.
The pytest file `test_student_candidate_robots_batch6.py` stays headless and fast.
"""
...
from ir_support_extra_robots.robots.OmronTM12X.OmronTM12X import OmronTM12X  # noqa: E402
from ir_support_extra_robots.robots.KukaK6R900.KukaK6R900 import KukaK6R900  # noqa: E402
from ir_support_extra_robots.robots.Kuka361.Kuka361 import Kuka361  # noqa: E402
from ir_support_extra_robots.robots.KukaAgilusKR.KukaAgilusKR import KukaAgilusKR  # noqa: E402
from ir_support_extra_robots.robots.JakaZu3.JakaZu3 import JakaZu3  # noqa: E402
...
def add_robot_buttons(env, robots):
    if HEADLESS:
        return
    env.add(swift.Label("Student candidate robots, batch 6"))
...
def main():
    ...
    print("Animating student candidate robot batch 6 in Swift...")
